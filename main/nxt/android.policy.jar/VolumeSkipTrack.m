...
#########
.method HandleVolumeLongPress(Landroid/view/KeyEvent;)Z
    .locals 6
    .prologue
...
## Stop timer ##
    ...
    iget-object v1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVolumeLongPressTimeoutRunnable:Ljava/lang/Runnable;
...
## Start Timer ##
    ...
    move-result v0
    if-eqz v0, :cond_0
    iput v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVolumeKeyCode:I

:cond_0
:goto_0
    iput-boolean v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVolumeLongPressed:Z
    return v3
.end method
